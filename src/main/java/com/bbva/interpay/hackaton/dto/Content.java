...
public class Content implements Serializable {
    ...
    private List<ExecutionResults> execution_results;
	...
	public List<ExecutionResults> getExecution_results() {
		return execution_results;
	}

	public void setExecution_results(List<ExecutionResults> execution_results) {
