...
public class AuthorizerInterPaymentController {

	Logger logger = (Logger) LoggerFactory.getLogger(AuthorizerInterPaymentController.class);
	
	
	@GetMapping(value = "bbva/interpay/auth", produces = MediaType.APPLICATION_JSON_VALUE)
	public ResponseEntity<AccessTokenObject> getAuthTokenBackendOriginator() {

		try {
			// Api Security RIPPLE
			AccessTokenObject accessToken = invokeServiceAuthBackendOriginator();
	...
	@PostMapping(value = "bbva/interpay/quote", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
	...
	@PostMapping(value = "bbva/payment-cross/simulate", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
	...
	@PostMapping(value = "bbva/payment-cross/execute", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
	...
	@PostMapping(value = "bbva/payment-cross/settle", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
	...
	public AccessTokenObject invokeServiceAuthBackendOriginator() {
		...
		ResponseEntity<?> responseEntity = restTemplate.exchange(Constantes.URL_GET_TOKEN_ORIGINATOR,
